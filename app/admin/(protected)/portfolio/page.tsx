...
export default async function AdminPortfolioPage({ searchParams }: { searchParams: Promise<{ saved?: string; deleted?: string; error?: string }> }) {
  ...
  return (
    <>
      ...
      {query.error === "featured_limit" ? <div className="admin-config-banner"><span>!</span><div><strong>Límite de destacados alcanzado</strong><p>Solo podés mostrar hasta 4 proyectos en el Home.</p></div></div> : null}
